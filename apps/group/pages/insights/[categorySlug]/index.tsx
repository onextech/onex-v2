    ...
    <PageProvider {...pageProviderProps}>
      <LandingLayout
        seo={{
          ...
          description: `Gain valuable insights about ${postCategory.title.toLowerCase()} on One X Group. Discover trends, strategies, and innovations for today's dynamic business landscape.`,
        }}
        autoBreadcrumbs
      >
