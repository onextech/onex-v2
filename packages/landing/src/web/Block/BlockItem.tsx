...
const DynamicDialog = dynamic(() =>
  import('@onex/ui').then((module) => module.Dialog)
)
    ...
    switch (type) {
      ...
      case BlockItemTypeEnum.BUTTON: {
        const DynamicButton = dynamic(() =>
          import('@onex/ui').then((module) => module.Button)
        )
        return (
          <Box {...boxProps}>
      ...
      case BlockItemTypeEnum.HTML: {
        const DynamicHtml = dynamic(() =>
          import('@onex/ui').then((module) => module.Html)
        )
        return (
          <Box {...boxProps}>
      ...
      case BlockItemTypeEnum.ACCORDION: {
        const DynamicAccordion = dynamic(() =>
          import('@onex/ui').then((module) => module.Accordion)
        )
      ...
      case BlockItemTypeEnum.LIST: {
        const DynamicList = dynamic(() =>
          import('@onex/ui').then((module) => module.List)
        )
