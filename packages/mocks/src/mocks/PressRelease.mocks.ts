...
export const MOCK_COMMON_PRESS_RELEASES: PressRelease[] = [
  ...
  },
  {
    ...
    title: 'Launch of NextGEN Connect Challenge Platform at the International Maritime Organisation Future of Shipping Conference 2022',
    ...
    subtitle: "The International Maritime Organisation and Maritime Port Authority of Singapore collaborated with One X Tech to launch NextGEN Connect Challenge, driving sustainable shipping and decarbonization efforts in the Asia-Pacific region.",
    html:
    ...
    '<p>NextGEN Connect Challenge seeks to cut greenhouse gas emissions along maritime routes in the Asia and Pacific regions by gathering original route-based action plans from various stakeholders. The entries were accepted via <a href="https://nextgen.imo.org/challenge">nextgen.imo.org/challenge</a>.</p>' + 
...
export const MOCK_TECH_PRESS_RELEASES: PressRelease[] = [
  ...MOCK_COMMON_PRESS_RELEASES,
  {
    ...
    '<p>One X Tech&rsquo;s newly-released website (<a href="https://onextech.com/">onextech.com</a>) serves as a thorough platform to highlight both its knowledge and commitment to offering cutting-edge software solutions suited to the particular requirements of companies in a range of industries. The website provides helpful insights into One X Tech\'s broad range of consulting services, including enterprise software development, digital transformation strategies, and technology-driven business solutions, and it has been updated with a user-friendly interface.</p>' +
    ...
    '<p>One X Tech\'s track record of assisting businesses in achieving their strategic goals through cutting-edge technological solutions is displayed on <a href="https://onextech.com/">onextech.com</a>. One X Tech aims to help businesses improve operational efficiency, optimize customer experiences, and maintain competitiveness in an ever-evolving market by leveraging their in-depth industry expertise and cutting-edge technical capabilities in frontend development.</p>' +
...
export const MOCK_DATA_PRESS_RELEASES: PressRelease[] = [
  ...MOCK_COMMON_PRESS_RELEASES,
  {
    ...
    html: '<p>30th May 2023</p>' +
    '<p>SINGAPORE: Today marks a significant milestone for One X Data as we proudly announce the official launch of our website, <a href="https://onexdata.co/">onexdata. co</a>. One X Data, a top supplier of business data and AI solutions, is proud to announce the launch of its website, <a href="https://onexdata.co/">onexdata.co</a>. One X Data is revolutionizing the way businesses harness and realize the potential of their data by focusing on leveraging cutting-edge technologies like Chat GPT and AI.</p>' +
    '<p>Businesses can explore One X Data\'s cutting-edge data and AI solutions on the recently launched <a href="https://onexdata.co/">onexdata.co</a> website, which offers a user-friendly platform. Businesses can confidently navigate the complex data landscape and extract useful insights using analytics, visualization, machine learning, and predictive modeling.</p>' +
    ...
    '<p>Business Development Director</p>' +
    '<p><a href="mailto:shu@onextech.com">shu@onextech.com</a></p>' +
    '<p>Through <a href="https://onexdata.co/">onexdata.co</a>, One X Data uses data and AI to create transformative change. With One X Data, explore the potential of data-driven innovation and realize the full potential of your company.</p>'
  },
].map((item, i) => ({
  id: i + 1,
  avatar_src: '/images/about_shape_circle_radial.svg',
...
export const MOCK_DESIGN_PRESS_RELEASES: PressRelease[] = [
  ...MOCK_COMMON_PRESS_RELEASES,
  {
    ...
    '<p>SINGAPORE: One X Design, a UI/UX service provider, is thrilled to announce the official launch of their new website, <a href="https://www.onexdesign.com/">www.onexdesign.com</a>. This exciting milestone marks a significant step forward in the company\'s mission to revolutionize the world of user experience and interface design.</p>' +
