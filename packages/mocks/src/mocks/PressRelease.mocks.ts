...
export const MOCK_GROUP_PRESS_RELEASES: PressRelease[] = [
  ...MOCK_COMMON_PRESS_RELEASES,
  {
    ...
    hero_src: '/unsplash/OUi93Rto_bw.jpg',
  ...
  },
  {
    ...
    hero_src: '/unsplash/tmTidmpILWw.jpg',
    hero_alt: 'hardware',
    html:
  ...
  },
  {
    ...
    hero_src:
      '/unsplash/macbook-pro-on-white-surface-WiONHd_zYI4.jpg',
    hero_alt: 'singapore',
    html:
      ...
      '<p>One X Data offers strategic data consulting along with analytics and <a href="https://www.finx.ai">AI solutions</a>. In order to create custom data strategies that ensure data governance, privacy, and security while maximizing the value of our clients&#39; data assets, our team of experts works closely with each client.</p>\n' +
