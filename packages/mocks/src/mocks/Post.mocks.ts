...
export const MOCK_TECH_POSTS = [
  {
    ...
    html:
      ...
      '</blockquote>\n' +
      '<p>More than just technological knowledge is needed to create an effective technical product. Key factors that can make or break a project were identified in research. The <em><strong>2015 Conditions for Project Success</strong></em> report is a collection of independent studies that aims to pinpoint the key elements that contribute to the effective completion of projects, programs, and portfolios. Any project, initiative, or portfolio can use these success criteria to help maximise project success.</p>\n' +
