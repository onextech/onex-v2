...
export const MOCK_TECH_POSTS = [
  {
    ...
    html:
      '<blockquote>\n' +
      '<p><em>Summary:</em></p>\n' +
      '<p><em>The Association for Project Management has listed five crucial factors for producing effective technical products in their "Conditions for Project Success" report. The factors include project planning and review, goals and objectives, effective governance, competent project teams, and dedication to success. The report emphasises that successful product creation calls for more than just simply technological expertise. Instead, effective management, a talented team, and a dedication to success are equally essential. To make sure everyone is working toward the same goals, it is vital, for instance, to conduct routine evaluations and set clear targets. Furthermore, in ensuring successful execution, there must be clear distinctions of authority and accountability within the project team and the commitment of everyone involved. By focusing on these factors, product owners can make a successful product that stands out from the competition while bringing additional value to their customers.</em></p>\n' +
      '</blockquote>\n' +
      '<p>More than just technological knowledge is needed to create an effective technical product. Key factors that can make or break a project were identified in research. The <em>2015 Conditions for Project Success</em> report is a collection of independent studies that aims to pinpoint the key elements that contribute to the effective completion of projects, programs, and portfolios. Any project, initiative, or portfolio can use these success criteria to help maximise project success.</p>\n' +
      ...
      '<p>According to the Association for Project Management\'s (APM) report "Conditions for Project Success," there are five important factors that define project success: project planning and review, goals and objectives, effective governance, competent project teams, and dedication to success.</p>\n' +
      '<h3>Project Planning and Review</h3>\n' +
  ...
  },
  {
    ...
    html:
      ...
      '<p>Besides the aforementioned, there are broader risk management strategies that can mitigate risks in product development. They consist of:</p>\n' +
      '<ul>\n' +
  ...
  },
  {
    ...
    html:
      ...
      '<p>To create effective user personas, you should include information about age, occupation, location, interests, and lifestyle. Consider the people utilising your product and what they will need it to do. Assess their motivations - why are they interested in your product? What do they hope to gain or achieve by employing it? Thinking from their perspective can help you determine which features to emphasise in your product design and marketing. Additionally, by understanding the context in which they will use your product, a more tailored experience can be provided to meet their needs.</p>\n' +
  ...
  },
  {
    ...
    html:
      ...
      '<p>In a cloud computing architecture known as "serverless," the infrastructure is managed by the cloud provider, and an organisation just pays for the computing time used by their&nbsp;applications. Organisations can concentrate on creating their applications without worrying about managing the underlying infrastructure thanks to serverless computing. It is a scalable and affordable option for businesses with different workloads.</p>\n' +
  ...
  },
  {
    ...
    html:
      '<blockquote>\n' +
      '<p><em>Summary: Enterprise product management has grown increasingly essential as a result of the way firms presently function after&nbsp;being altered by cloud-based solutions. Enterprise product managers should take important considerations into account, such as choosing an appropriate cloud provider based on standards like cost, dependability, security, scalability, and support. In order to be sure that their infrastructure and cloud provider can accommodate their expanding business needs, they must also plan for expansion. Another crucial element is cost optimization, and product managers must assess cloud usage and cut costs where they can without sacrificing performance or reliability. Finally, investing in cutting-edge technology and researching concepts like serverless computing and microservices are crucial.</em></p>\n' +
      '</blockquote>\n' +
      ...
      '<p>Product managers can acquire a competitive edge and ensure their company is prepared to make the most out of opportunities in the cloud computing market by embracing innovation.</p>\n' +
      '<h2>Conclusion</h2>\n' +
  ...
  },
  {
    ...
    html:
      '<blockquote>\n' +
      '<p><em>Summary: The global demand for commodities and raw resources is driving a rapid transformation in the maritime industry. Robotics, AI, and machine learning are enabling automation, which is reducing the need for human staff, increasing productivity, minimizing human error, and boosting safety. To improve shipping routes and make more informed judgments, big data and analytics are being leveraged. Secure and transparent product and transaction tracking is made possible by blockchain technology. Ships are being powered by renewable energy sources including wind turbines, solar panels, and fuel cells, which lessens their carbon footprint. Spare parts and ship components are being produced on demand using 3D printing, which reduces the time and cost associated with maintaining and repairing vessels. These developments may increase output, lower expenses, and improve sustainability and safety.</em></p>\n' +
      '</blockquote>\n' +
  ...
  },
  {
    ...
    html:
      '<blockquote>\n' +
      '<p><em>Summary: The real estate market has been significantly impacted by technology, which now allows buyers, sellers, and property management to trade online via a variety of channels. Also, these systems offer useful data and analytics to aid with decision-making. Property management has now become easier with&nbsp;smart home devices that&nbsp;allow for&nbsp;remote monitoring of many aspects of a structure. The sector has also been altered by virtual and augmented reality, which has improved the experiences of both buyers and sellers and allowed for virtual property tours. Data analysis and the automation of real estate administration are being performed via artificial intelligence and machine learning. Further innovations and developments in the real estate industry might be anticipated as technology develops further.</em></p>\n' +
      '</blockquote>\n' +
  ...
  },
  {
    ...
    html:
      '<blockquote>\n' +
      "<p><em>Summary:</em> <em>Developing scalable applications is crucial for businesses to remain competitive and meet customer demands. Scalable applications have three key attributes: they can scale globally, respond to demand, and scale based on specific needs. Businesses must prioritise&nbsp;the end-user experience, have a modular codebase, and guarantee lag-free application performance in to build scalable apps. Developers must also be diligent about system maintenance, data backups, and utilise automated testing tools. Furthermore,&nbsp;in order to remain competitive and relevant, developers must follow up with industry news. By adhering to best practices and making a commitment to system maintenance, businesses can develop reliable solutions that satisfy customers' expectations both now and in the future.</em></p>\n" +
      '</blockquote>\n' +
  ...
  },
  {
    ...
    html:
      ...
      '<p>React Native is a framework for building native mobile apps using React. It provides a means for developers to centralise and control the state of their program in a reliable and predictable manner. Data flows and application design are made simpler.</p>\n' +
      '<h3>6. Server-Side Rendering:</h3>\n' +
      ...
      '<h3>9. React Performance Optimisation:</h3>\n' +
...
export const MOCK_GROUP_POSTS = [
  {
    ...
    html:
      '<blockquote>\n' +
      "<p><em>Summary: Organisations in today's business world are seeking to attain long-term success and sustainable growth. Growth strategies are essential for any organisation that wants to compete in an increasingly competitive marketplace. However, developing a successful, cost-effective growth strategy is not easy, as it involves making choices on resources, technology, marketing and customer acquisition.</em></p>\n" +
  ...
  },
  {
    ...
    html:
      ...
      '<p>In today&rsquo;s competitive business world, staying ahead of the game means having access to the latest technologies and being able to successfully implement them. Implementing new technology can be a daunting task and success requires meticulous preparation and execution. So, we&rsquo;ve done the hard lifting for you. This guide will provide you with all the information you need to successfully implement new technologies within your organisation and level up your business.</p>\n' +
      '<h2>Conduct a Needs Assessment</h2>\n' +
      ...
      '<p>Establish your implementation rationale; <em>why</em> is your company implementing this new software?</p>\n' +
      '<p><em>Is your company implementing this technology to:</em></p>\n' +
      '<ul>\n' +
      ...
      '</ul>\n' +
      '<h2>Create a Cross-Functional Team</h2>\n' +
      ...
      '<h2>Develop a Comprehensive Implementation Plan</h2>\n' +
      ...
      '<p><em>Your Implementation Plan should Include:</em></p>\n' +
      '<ul>\n' +
      ...
      '<p><em>Your training plan should include:</em></p>\n' +
      '<ul>\n' +
      ...
      '</ul>\n' +
      '<h2>Monitor and Evaluate Progress</h2>\n' +
      ...
      "<p>To stay up with the latest trends and advancements, it is critical to adjust and enhance your execution strategy. You can ensure that your organisation stays relevant in today's rapid evolving marketplace by remaining on top of industry changes and adjusting effectively.</p>\n" +
      '<p>Choosing the right technology to meet organisational objectives does not have to be a guessing game.</p>\n' +
  ...
  },
  {
    ...
    html:
      ...
      '<p>With IPA, businesses can automate many manual operations that take up valuable time and resources. By employing IPA successfully, companies can better allocate their people and resources for more meaningful tasks and drive efficiency across the organisation suggesting that focus can be shifted heavily on growing their operations - providing better service to customers. Additionally, IPA provides businesses with access to analytics that enable them to gain insight into how their processes are performing, identify any bottlenecks or potential areas of improvement, and design more efficient workflows. While IPA takes over rote tasks, employers can focus on delighting customers and considering how new troves of data outside the organisation&mdash;from news, events, social media, embedded sensors, and elsewhere&mdash;will aid in achieving business objectives.</p>\n' +
      '<h3>Scalability</h3>\n' +
  ...
  },
  {
    ...
    html:
      ...
      '<h2>Imagery</h2>\n' +
      '<p>The brand should choose visuals that are consistent with its values and messaging. Photographs, illustrations, and graphics are examples of such&nbsp;visuals. The imagery used by the brand should be consistent across all touchpoints, resulting in a unified and identifiable visual identity.</p>\n' +
      '<h2>Brand Message</h2>\n' +
  ...
  },
  {
    ...
    html:
      ...
      "<p>Organisational design refers to the process of structuring and aligning an organisation's systems, processes, and people to achieve its goals. In the realm of talent management, organisational design is crucial in establishing the ideal atmosphere for employees to thrive and contribute to the organisation's success.</p>\n" +
      '<p>Here are some key ways that organisational design can help build better teams:</p>\n' +
      ...
      "<h3>Defining the organisation's Goals and Objectives</h3>\n" +
      "<p>The aims and objectives of the organisation must be aligned&nbsp;with the organisational design. This entails taking the effort to clearly define the organisation's goals and identifying the skills and competencies required to attain them.</p>\n" +
      '<h3>Identifying Key Roles and Skills</h3>\n' +
      "<p>Determining the critical responsibilities and talents required to meet the organisation's goals and objectives involves performing a detailed examination of the organisation's current staff in order to identify any skill shortfalls or areas where additional expertise is required.</p>\n" +
...
export const MOCK_FINX_POSTS = []

export const MOCK_GOVX_POSTS = []
